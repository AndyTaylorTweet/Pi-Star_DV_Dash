...
// Tomasz Sacinski (SQ7BR)
// Created: 20-May-2020
//
$lang = array (
  // Banner texts
  "digital_voice"               =>  "Głos cyfrowy",
  "configuration"               =>  "Konfiguracja",
  "dashboard_for"               =>  "Tablica dla",
  // Banner links
  "dashboard"                   =>  "Tablica",
  "admin"                       =>  "Administrator",
  "power"                       =>  "Zasilanie",
  ...
  "control_software"            =>  "Program Kontrolujący",
  ...
  "controller_software"         =>  "Program Kontrolera",
  ...
  "node_type"                   =>  "Typ Noda",
  "timezone"                    =>  "Strefa Czasowa Systemu",
  "dash_lang"                   =>  "Język Tablicy",
  ...
  "dstar_irc_password"          =>  "Zdalne Hasło",
  ...
  "callsign"                    =>  "Znak",
  "target"                      =>  "Cel",
  "src"                         =>  "Źr.",        // Short version of "Source"
  "dur"                         =>  "Trw.",        // Short version of "Duration"
  "loss"                        =>  "Utrata",
  "ber"                         =>  "BER",        // Short version of "Bit Error Rate"
  // POCSAG Specific
  "pocsag_list"                 =>  "Aktywność Bramki DAPNET",
  ...
  "local_tx_list"               =>  "Lokalna Aktywność Radiowa",
  "active_starnet_groups"       =>  "Actywne Grupy Starnet",
  "active_starnet_members"      =>  "Aktywni Członkowie Grupy Starnet",
  "d-star_link_manager"         =>  "Zarządzca Linków D-Star",
  "d-star_link_status"          =>  "Informacja O Linkach D-Star",
