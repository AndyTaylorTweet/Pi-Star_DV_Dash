...
$lang = array (
  ...
  "dashboard_for"               =>  "Panell de control per",
  // Banner links
  ...
  "mmdvmhost_config"            =>  "Configuracio de MMDVMHost",
  "general_config"              =>  "Configuracio General",
  "dmr_config"                  =>  "Configuracio de DMR",
  "dstar_config"                =>  "Configuracio de DSTAR",
