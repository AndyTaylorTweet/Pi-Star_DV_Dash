...
$lang = array (
  ...
  "dmr_master"                  =>  "Κεντρικός Υπολογιστής DMR (MMDVMHost)",
  "bm_master"                   =>  "Κεντρικός Υπολογιστής BrandMeister",
  "bm_network"                  =>  "Δίκτυο BrandMeister",
  "dmr_plus_master"             =>  "Κεντρικός Υπολογιστής DMR+",
  "dmr_plus_network"            =>  "Δίκτυο DMR+",
  "xlx_master"                  =>  "Κεντρικός Υπολογιστής XLX",
  "xlx_enable"                  =>  "Ενεργοποίηση Κεντρικού Υπολογιστή XLX",
  ...
  "dmr_master"                  =>  "Κεντρικός Υπολογιστής DMR",
  "ysf_net"                     =>  "Δίκτυο YSF",
  ...
  "callsign"                    =>  "Διακριτικό",
  "target"                      =>  "Προορισμός",
  "src"                         =>  "Πηγαίος",        // Short version of "Source"
