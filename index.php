...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 820px) and (min-display-width: 820px)" href="css/ircddb.css" />
    <link rel="stylesheet" type="text/css" media="screen and (max-width: 819px) and (max-display-width: 819px)" href="css/mini_ircddb.css" />
