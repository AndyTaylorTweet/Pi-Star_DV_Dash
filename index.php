...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-device-width: 820px)" href="css/ircddb.css" />
    <link rel="stylesheet" type="text/css" media="screen and (max-device-width: 819px)" href="css/mini_ircddb.css" />
