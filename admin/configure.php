...
<?php
    ...
    <td style="text-align: left;"><input type="button" onclick="https://brandmeister.network/?page=hotspot&amp;id='.$configmmdvm['DMR']['Id'].'" target="_new" value="Repeater Info"> | <input type="button" onclick="https://brandmeister.network/?page=hotspot-edit&amp;id='.$configmmdvm['DMR']['Id'].'" target="_new" value="Edit Repeater (Set TalkGroup)"></td>
    </tr>'."\n";}
?>
    <tr>
