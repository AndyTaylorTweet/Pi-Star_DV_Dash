...
<div>
  <table align="center" width="760px" style="margin: 0px 0px 10px 0px; width: 100%;">
    <tr>
    <td align="center" valign="top" style="background-color: #ffff90; color: #906000;">Alert: You have a BM API v1 Key, click here for the announcement: <a href="https://news.brandmeister.network/major-code-upgrade-on-august-19th/" alt="BM API v2 - Announcement">BM API v2 - Announcement</a>.</td>
    </tr>
  </table>
</div>
<?php } } ?>
