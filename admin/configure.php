...
<?php if (!empty($_POST)):
	...
	if (empty($_POST['MMDVMModeDMR2YSF']) != TRUE ) {
		  ...
		  $configdmrgateway['DMR Network 3']['TGRewrite'] = "2,700001,2,1,99999";
		  $configdmrgateway['DMR Network 3']['SrcRewrite'] = "2,1,2,700001,99999";
		  $configdmrgateway['DMR Network 3']['PCRewrite'] = "2,700001,2,1,99999";
...
<?php if (file_exists('/etc/dstar-radio.mmdvmhost')) { ?>
	...
	if ( $configmmdvm['DMR']['Enable'] == 1 ) {
		echo "<td align=\"left\"><div class=\"switch\"><input id=\"toggle-dmr\" class=\"toggle toggle-round-flat\" type=\"checkbox\" name=\"MMDVMModeDMR\" value=\"ON\" checked=\"checked\" aria-label=\"Turn DMR Mode Off\" /><label for=\"toggle-dmr\"></label></div></td>\n";
		}
	else {
		echo "<td align=\"left\"><div class=\"switch\"><input id=\"toggle-dmr\" class=\"toggle toggle-round-flat\" type=\"checkbox\" name=\"MMDVMModeDMR\" value=\"ON\" aria-label=\"Turn DMR Mode On\" /><label for=\"toggle-dmr\"></label></div></td>\n";
	}
    ?>
