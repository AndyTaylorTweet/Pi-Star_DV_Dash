...
<?php if ( $configmmdvm['POCSAG']['Enable'] == 1 ) { ?>
    ...
    <table>
      ...
      <tr>
        <td align="left"><a class="tooltip2" href="#">DAPNET <?php echo $lang['dapnet_authkey'];?>:<span><b>DAPNET Transmitter AuthKey</b>Set your DAPNET transmitter AuthKey<br /> here</span></a></td>
