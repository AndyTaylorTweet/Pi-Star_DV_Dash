...
<?php if (!empty($_POST)):
	...
	// Set RPT1 and RPT2
	  ...
	  $rollIRCrepeaterCall1 = 'sudo sed -i "/repeaterCall1=/c\\repeaterCall1='.strtoupper(escapeshellcmd($_POST['confCallsign'])).'" /etc/ircddbgateway';
...
<br />
    ...
    <td align="left" colspan="2"><input type="text" name="dmrId" size="13" maxlength="7" value="<?php echo $configmmdvm['DMR']['Id']; ?>"></td>
    </tr><?php } ?>
