...
<?php if (file_exists('/etc/dstar-radio.mmdvmhost')) { ?>
    ...
    <?php if (file_exists('/etc/dstar-radio.mmdvmhost') && (($configmmdvm['DMR']['Enable'] == 1) || ($configmmdvm['System Fusion']['Enable'] == 1 ) || ($configysf2dmr['Enabled']['Enabled'] == 1) || ($configmmdvm['P25']['Enable'] == 1 ))) { ?>
    <tr>
    ...
    <?php if (file_exists('/etc/dstar-radio.mmdvmhost') && ( ($configmmdvm['NXDN']['Enable'] == 1) || ($configysf2nxdn['Enabled']['Enabled'] == 1) )) { ?>
    <tr>
