...
<?php } else { ?>
  ...
  <tr>
    <td align="center">Backup<br /><input type="image" src="/images/backup.png" name="action" value="backup" /></td>
    <td align="center">Restore<br /><input type="image"  src="/images/restore.png" name="action" value="restore" /></td>
  </tr>
  </table>
  </form>
<?php } ?>
