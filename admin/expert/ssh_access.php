...
?>
  ...
  <tr><td align="left"><div id="tail">
    <?php if (isset($shellPort)) {
      echo "<iframe src=\"https://".$_SERVER['HTTP_HOST'].":".$shellPort."\" style=\"border:0px #ffffff none;\" name=\"Pi-Star SSH\" scrolling=\"no\" frameborder=\"0\" marginheight=\"0px\" marginwidth=\"0px\" height=\"100%\" width=\"100%\"></iframe>";
    }
    else {
