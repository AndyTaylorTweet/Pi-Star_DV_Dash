...
echo "<tr><th>RPT1</th><td style=\"background: #ffffff;\">".$configs['gatewayCallsign']." ".$configs['repeaterBand1']."</td></tr>\n";
echo "<tr><th>RPT2</th><td style=\"background: #ffffff;\">".$configs['gatewayCallsign']." G</td></tr>\n";
