      ...
      elseif ( (isset($bmAPIkeyV2)) && ( (isset($bmAPIkeyV2)) && ( !empty($_POST) && ( isset($_POST["dropDyn"]) || isset($_POST["dropQso"]) || isset($_POST["tgSubmit"]) ) ) ) ): // Data has been posted for this page
        ...
        if (isset($bmAPIkey) || isset($bmAPIkeyV2)) {
          ...
          echo '<tr>
            ...
            <th aria-hidden="true" id="lblAddRemove" style="width:25%;"><a class=tooltip href="#">Add / Remove<span><b>Add or Remove</b></span></a></th>
          ...
          echo '<td role="radiogroup" aria-labelledby="lblSlot"><input id="rbTS1" type="radio" name="TS" value="1" /><label for="rbTS1">TS1</label> <input id="rbTS2" type="radio" name="TS" value="2" checked="checked" /><label for="rbTS2">TS2</label></td>';
